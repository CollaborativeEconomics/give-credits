    ...
    <div className="flex min-h-full w-full">
      <Card className="py-6 w-full">
        ...
        <div className="flex flex-col items-center justify-center">
          <Button disabled={disabled} className="mt-6 mx-6 w-[250px] h-[50px] bg-green-500 text-white text-lg outline outline-slate-300 outline-1 hover:bg-green-600 hover:shadow-inner" onClick={onAction}>
            {buttonText}
          </Button>
