        ...
        <div className="container flex flex-col">
          ...
          <div className="flex flex-row justify-center my-12">
            ...
            <div className="ml-12">
              ...
              <p className="py-3">When you make a donation to Public Node (a registered 501C3 non-profit), Soroban smart contracts automatically allocate funds into chunks to purchase carbon credits, and you receive a receipt NFT showing the estimated offset</p>
          ...
          <div className="text-center mb-12">
            <Link href={featured} className="px-12 py-4 text-2xl text-green-600 rounded-full border shadow-xl">Contribute Now</Link>
          </div>
        </div>
        ...
        <div className="flex flex-col mt-16 bg-[url('/newui/bg.jpg')] bg-center bg-bottom bg-no-repeat">
          ...
          <div className="container pt-24">
            <div className="flex flex-col w-[920px] rounded-lg bg-slate-400 bg-[#00000022] justify-center items-center mx-auto mt-16 p-12 shadow-xl">
              <h2 className="mb-12 text-white text-4xl font-bold">{percent}% Carbon Neutral</h2>
              <MainChart goal={goal} value={current} />
              <p className="mt-4 text-white">{current} out of {goal} tons of carbon offset as of {date}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col mt-24 pb-24">
            <div className="text-center">
              <h2 className="mt-6 mb-12 text-white text-4xl font-bold">Recent Carbon Credit Retirements</h2>
